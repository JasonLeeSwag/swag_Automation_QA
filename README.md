...
- 切換動作: `切換至xxx` (例如：切換至新視窗、切換至 iframe)
...
1. [XPath 效能優化指南](https://www.selenium.dev/documentation/webdriver/elements/locators/#xpath)
2. [XPath 定位元素最佳實踐](https://www.guru99.com/xpath-selenium.html)
3. [動態 XPath 處理技巧](https://www.lambdatest.com/blog/complete-guide-for-using-xpath-in-selenium-with-examples/)
...
//[contains(@data-test-id, 'submit')] # 使用自定義屬性
相對路徑選擇器
