...
SVC_NAME="actions.runner.JasonLeeSwag-swag_Automation_QA.Mac-GUI-Runner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (JasonLeeSwag-swag_Automation_QA.Mac-GUI-Runner)"
